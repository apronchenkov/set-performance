...
// Sequential insert
template <class IntegerSet> Duration RandomInsertTestImpl(IntegerSet set, int n) {
...
template <class IntegerSet> Duration RandomInsertTest(IntegerSet set, int n, int k = 32) {
